...
const treeVariants = cva(
    'group rounded-lg px-2 text-left font-normal hover:bg-accent/60 hover:text-accent-foreground'
)

const selectedTreeVariants = cva(
    'bg-primary/15 text-primary hover:bg-primary/20 hover:text-primary font-normal'
)
            ...
            >
                {renderItem ? (
                    ...
                    <>
                        ...
                        />
                        <span className="flex-grow text-sm font-normal truncate">{item.name}</span>
